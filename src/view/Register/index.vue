    ...
    <div class="register">
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="手机号:" prop="phone">
          <el-input type="password" v-model.number="ruleForm.phone"></el-input>
        </el-form-item>
        <el-form-item label="验证码" prop="code">
          <el-input type="password" v-model="ruleForm.code"></el-input>
          <el-button type="primary" @click="getCode" size="mini">点击获取验证码</el-button>
        </el-form-item>
        ...
        <el-form-item>
          <el-checkbox v-model="ruleForm.agree">同意协议并注册《尚品汇用户协议》</el-checkbox>
        </el-form-item>
        <el-form-item>
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          //解构出参数
          const { phone, code, password, password1, agree } = this.ruleForm;
          //判断是否勾选
          if (agree) {
            //通知vuex发请求，进行用户的注册
            try {
...
.register-container {
  .register {
    ...
    div[data-v-7e520632]:nth-of-type(1) {
      margin-top: 0px;
    }
